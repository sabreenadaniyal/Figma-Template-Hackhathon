        ...
        <div className='wrapper flex flex-col '>
            ...
            <div className='h-[240px] flex justify-evenly mt-[50px] '>
                <div className='w-[336px] h-[161.58] flex flex-col  p-6 border-2 border-[#0000001A] rounded-[20px] ml-5'>
                    ...
                    <p className='text-[16px] leading-[22px] font-normal'>I am blown away by the quality and style of the clothes I received from Shop.co. From casual wear to elegant dresses, every piece I have bought has exceeded my expectations.</p>
                ...
                <div className='w-[336px] h-[161.58] flex flex-col  p-6 border-2 border-[#0000001A] rounded-[20px]'>
                    ...
                    <div className='flex'> <h1 className='font-bold *:text-[20px]'>James L.</h1>
                        <span><Image src="/hero section/green tick.png" alt="customer" width={20} height={20} /></span></div>
                    <p className='text-[16px] leading-[22px] font-normal'>As someone who&apos;s always on the lookout for unique fashion pieces, I am thrilled to have stumbled upon Shop.co. The selection of clothes is not only diverse but also on-point with the latest trends.</p>
